                    ...
                    <div class="card-body">
                       ...
                       <div class="form-grup">
                        ...
                        <div class="form-grup">
                            ...
                            <input type="number" inputmode="numeric" name="price" id="peice" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}">
                            @error('price')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-grup">
                            ...
                            <input type="number" inputmode="numeric" name="stock" id="peice" class="form-control @error('stock') is-invalid @enderror" value="{{ old('stock') }}">
                            @error('stock')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
